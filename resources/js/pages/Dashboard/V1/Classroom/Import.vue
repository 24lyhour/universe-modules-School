...
const handlePreview = async () => {
    ...
    try {
        const response = await fetch('/dashboard/classrooms/import/preview', {
            method: 'POST',
            headers: {
...
const handleImport = () => {
    ...
    router.post('/dashboard/classrooms/import', {
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold">Import Classrooms</h1>
                    <p class="text-sm text-muted-foreground">
                        Upload an Excel or CSV file to import classrooms
                    </p>
                </div>
            </div>
            ...
            <div v-if="currentStep === 'upload'" class="grid gap-6 md:grid-cols-2">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Select an Excel (.xlsx, .xls) or CSV file to import classrooms
                        </CardDescription>
                    </CardHeader>
                ...
                <Card>
                    ...
                    <CardContent class="space-y-4">
                        <ol class="list-decimal list-inside space-y-2 text-sm">
                            ...
                            <li>Fill in the classroom data following the template format</li>
                ...
                <CardFooter class="flex justify-between">
                    ...
                    <div class="flex gap-2">
                        ...
                        <Button :disabled="!canImport" @click="handleImport">
                            ...
                            Import {{ previewStats ? previewStats.ready + previewStats.update : 0 }} Classrooms
                        </Button>
                    </div>
                </CardFooter>
            </Card>
            ...
            <Card v-if="currentStep === 'importing'" class="max-w-md mx-auto">
                <CardHeader class="text-center">
                    ...
                    <CardTitle>Importing Classrooms</CardTitle>
                    <CardDescription>
