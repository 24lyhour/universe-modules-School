...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: props.course.name, href: `/dashboard/courses/${props.course.id}` },
];

const handleEdit = () => {
    router.visit(`/dashboard/courses/${props.course.id}/edit`);
};

const handleDelete = () => {
    router.visit(`/dashboard/courses/${props.course.id}/delete`);
};
</script>
