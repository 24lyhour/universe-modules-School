...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Import', href: '/dashboard/departments/import' },
];
...
const handlePreview = async () => {
    ...
    try {
        const response = await fetch('/dashboard/departments/import/preview', {
            method: 'POST',
            headers: {
...
const handleImport = () => {
    ...
    router.post('/dashboard/departments/import', {
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold">Import Departments</h1>
                    <p class="text-sm text-muted-foreground">
                        Upload an Excel or CSV file to import departments
                    </p>
                </div>
            </div>
            ...
            <div v-if="currentStep === 'upload'" class="grid gap-6 md:grid-cols-2">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Select an Excel (.xlsx, .xls) or CSV file to import departments
                        </CardDescription>
                    </CardHeader>
                ...
                <Card>
                    ...
                    <CardContent class="space-y-4">
                        <ol class="list-decimal list-inside space-y-2 text-sm">
                            ...
                            <li>Fill in the department data following the template format</li>
                        ...
                        <Alert>
                            ...
                            <AlertDescription>
                                Name and Code are required. Code must be unique within the school.
                            </AlertDescription>
                        </Alert>
                ...
                <CardFooter class="flex justify-between">
                    ...
                    <div class="flex gap-2">
                        ...
                        <Button :disabled="!canImport" @click="handleImport">
                            ...
                            Import {{ previewStats ? previewStats.ready + previewStats.update : 0 }} Departments
                        </Button>
                    </div>
                </CardFooter>
            </Card>
