...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Import', href: '/dashboard/equipment/import' },
];
...
const handlePreview = async () => {
    ...
    try {
        const response = await fetch('/dashboard/equipment/import/preview', {
            method: 'POST',
            headers: {
...
const handleImport = () => {
    ...
    router.post('/dashboard/equipment/import', {
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-muted-foreground">
                        Upload an Excel or CSV file to import equipment
                    </p>
                </div>
            </div>
            ...
            <div v-if="currentStep === 'upload'" class="grid gap-6 md:grid-cols-2">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Select an Excel (.xlsx, .xls) or CSV file to import equipment
                        </CardDescription>
                    </CardHeader>
                ...
                <Card>
                    ...
                    <CardContent class="space-y-4">
                        <ol class="list-decimal list-inside space-y-2 text-sm">
                            ...
                            <li>Fill in the equipment data following the template format</li>
                        ...
                        <Alert>
                            ...
                            <AlertDescription>
                                Name is required. Category must be one of: technology, furniture, safety, accessibility, other.
                            </AlertDescription>
                        </Alert>
                ...
                <CardFooter class="flex justify-between">
                    ...
                    <div class="flex gap-2">
                        ...
                        <Button :disabled="!canImport" @click="handleImport">
                            ...
                            Import {{ previewStats ? previewStats.ready + previewStats.update : 0 }} Equipment
                        </Button>
                    </div>
                </CardFooter>
            </Card>
